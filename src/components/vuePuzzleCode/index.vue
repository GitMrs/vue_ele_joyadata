  ...
  computed: {
    ...
    styleWidth() {
      ...
      return w < this.sliderBaseSize
        ? this.sliderBaseSize : w > this.canvasWidth ? this.canvasWidth : w;
    },
  ...
  watch: {
    show(newV) {
      ...
      if (newV) {
        ...
        // document.body.className += '' + 'vue-puzzle-overflow';
        this.reset();
      } else {
        // document.body.classList.remove('vue-puzzle-overflow');
        // document.body.className.replace(new RegExp('(\\s|^)' + 'vue-puzzle-overflow' + '(\\s|$)'), '');
      }
    },
  },
  /** 生命周期 **/
